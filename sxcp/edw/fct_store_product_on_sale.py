...
def mon_loop(days, first_date):
    for i in range(0, days):
        min_day = datetime.datetime.strptime(first_date, "%Y-%m-%d") + datetime.timedelta(days=i)
...
for i in range(0, 5):
    ...
    days = [28, 31, 30, 31, 3]
    first_dates = ['2018-09-03', '2018-10-01', '2018-11-01', '2018-12-01', '2019-01-01']
    mon_loop(days[i], first_dates[i])
