...
left join rbu_sxcp_edw_dev.fct_check_daily_stock d on date_sub(a.bill_date,1)=d.check_date and a.shop_code=d.store_code and a.product_code=d.product_code
