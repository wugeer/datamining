...
from tmp5_spark a 
left join rbu_sxcp_edw_ai_dev.store_category b on a.store_code=b.store_code and b.date='{0}'
where a.date_case=b.case
group by store_code,
product_code,
date_case
""".format(item)
...
insert_sql = """
insert into table rbu_sxcp_edw_ai_dev.sale_add_avg partition(sale_date)
(
select 
store_code,
product_code,
