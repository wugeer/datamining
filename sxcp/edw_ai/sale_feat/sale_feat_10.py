...
def jiaoben(item):
    ...
    # and t1.date_case is not null and Boolean(check_date_case(t1.date_case)) and coalesce(t1.turnover,0)>=0 and t2.sale_total_qty is not null and t2.sale_total_qty>=0
